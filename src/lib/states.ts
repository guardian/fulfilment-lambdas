...
const normalise = (string) => string.toUpperCase();
const normaliseTuple = (tuple) => [normalise(tuple[0]), tuple[1]];
...
export function getCanadianState(name) {
...
export function getUSState(name) {
